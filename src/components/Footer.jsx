...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t border-blue-200 relative">
      {/* Alert Notification - TOP POSITION */}
      <AnimatePresence>
        {showAlert && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-20 md:top-24 left-4 right-4 md:left-1/2 md:right-auto md:transform md:-translate-x-1/2 z-50 bg-linear-to-r from-blue-600 to-cyan-600 text-white px-4 md:px-8 py-3 md:py-4 rounded-xl shadow-2xl flex items-center gap-2 md:gap-3 w-auto md:max-w-md"
          >
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <motion.div
            ...
            className="mt-6 inline-flex items-center gap-2 bg-linear-to-r from-blue-600 to-cyan-600 text-white px-6 py-2 rounded-full shadow-lg"
          >
            <Star size={18} />
            <span className="font-semibold text-sm md:text-base">
              Launching 1st February 2026
            </span>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-blue-300">
          ...
          <div className="flex items-center gap-2 text-gray-700">
            <div className="flex items-center gap-2">
              <div className="bg-linear-to-r from-blue-600 to-cyan-600 rounded-lg p-1">
                <img
                  src="/logo.png"
                  alt="ReckMe"
