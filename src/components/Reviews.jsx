  ...
  const reviews = [
    {
      ...
      review: "Amazing service! The companion I booked was professional, respectful, and made me feel completely comfortable. The booking process was seamless and secure. Highly recommend Dil Se!",
      avatar: "PS",
    },
    {
      name: "Rahul Verma",
      ...
      <div className="max-w-7xl mx-auto mb-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            What Our <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-cyan-600">Clients Say</span>
          </h2>
        ...
        {showAlert && (
          ...
          >
            ...
            <div>
              <p className="font-semibold text-lg">Review Feature Coming Soon!</p>
              <p className="text-sm text-blue-100">These are sample reviews. You'll be able to add your own review shortly.</p>
            </div>
          </motion.div>
        )}
      </div>
